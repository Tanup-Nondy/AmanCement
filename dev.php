      ...
      <div class="container">
		...
		<div class="row">
          ...
          <div class="col-lg-6 col-md-9 box wow bounceInUp" data-wow-duration="1.4s">
            ...
            <h4 class="title"><button class="form-control" type="submit" value="add" name="add"><a href="insert_dev.php">Add Data</a></button></h4>
          </div>
          <div class="col-lg-6 col-md-9 box wow bounceInUp" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-paper-outline"></i></div>
            <h4 class="title"><button class="form-control" type="submit" value="print" name="print"><a href="print_dev.php">Print Data</a></button></h4>
          </div>
...
<div class="container-fluid">
  ...
  <div class="card mb-3">
	<div class="card-header">
	  <i class="fa fa-table"></i> Developers List of <?php $name=$_SESSION["dis"]; echo $name; ?> District</div>
	<div class="card-body">
...
$select="SELECT `SI_NO`,`Category`, `Name_of_com`, `PO_UP`, `Name_of_des_maker`, `Position`, `Address`, `Mob_Phn`, `Pro_Per`, `Mobile_Phn`, `district` FROM `dev` where district='$name'";
...
if($chk){
	...
	while($row=mysqli_fetch_array($chk)){
		...
		<form method="post" action="view_single_dev.php" >
		...
		<form method="post" action="dev_action.php" >
