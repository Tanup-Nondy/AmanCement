    ...
    <section id="services">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp">
          <h3>Update Entry in Technical Employee Database<?php $name=$_SESSION["dis"];?> </h3>
		  </center>
        </header>
...
$name=$_SESSION['dis'];
	...
	$id=$_POST['update'];
	$select="SELECT * FROM `tech_emp` where SI_NO='$id'";
	$chk=mysqli_query($cn,$select);
	if($chk){
		echo '<form method="post" action="edit_tech_emp_action.php">';
