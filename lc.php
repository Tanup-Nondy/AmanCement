...
<section id="services">
  <div class="container">
	...
	<header class="section-header wow fadeInUp">
	  <h3>Contractor List of <?php $name=$_SESSION["dis"]; echo $name; ?> District </h3>
	</header>
	...
	<div class="row">
	  ...
	  <div class="col-lg-6 col-md-9 box wow bounceInUp" data-wow-duration="1.4s">
		...
		<h4 class="title"><button class="form-control" type="submit" value="add" name="add"><a href="insert_lc.php">Add Data</a></button></h4>
	  </div>
	  <div class="col-lg-6 col-md-9 box wow bounceInUp" data-wow-duration="1.4s">
		<div class="icon"><i class="ion-ios-paper-outline"></i></div>
		<h4 class="title"><button class="form-control" type="submit" value="print" name="print"><a href="print_lc.php">Print Data</a></button></h4>
	  </div>
		...
		<table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
		  <thead>
			<tr>
				...
				<th>Potenial upcoming projects</th>
...
include("dbconnect.php");
	...
	$select="SELECT `SI_NO`,`Category`, `Name_of_com`, `PUP`, `Name_of_des_maker`, `Position`, `Address`, `Mob_Phn`, `Pro_Per`, `Mobile_Phn`, 'district' FROM `lc`where district='$name'";
