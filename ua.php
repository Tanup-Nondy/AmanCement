      ...
      <div class="container">
		...
		<div class="row">
          ...
          <div class="col-lg-6 col-md-9 box wow bounceInUp" data-wow-duration="1.4s">
            ...
            <h4 class="title"><button class="form-control" type="submit" value="add" name="add"><a href="insert_ua.php">Add Data</a></button></h4>
          </div>
          <div class="col-lg-6 col-md-9 box wow bounceInUp" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-paper-outline"></i></div>
