      ...
      <div class="container">
		...
		<div class="row">
          ...
          <div class="col-lg-6 col-md-9 box wow bounceInUp" data-wow-duration="1.4s">
            ...
            <h4 class="title"><button class="form-control" type="submit" value="add" name="add"><a href="insert_ngo.php">Add Data</a></button></h4>
          </div>
          <div class="col-lg-6 col-md-9 box wow bounceInUp" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-paper-outline"></i></div>
            <h4 class="title"><button class="form-control" type="submit" value="print" name="print"><a href="print_ngo.php">Print Data</a></button></h4>
          </div>
...
include("dbconnect.php");
	...
	$select="SELECT `SI_NO`,`Category`, `Name_of_com`, `PO_UP`, `Name_of_des_maker`, `Position`, `Address`, `Mob_Phn`, `Pro_Per`, `Mobile_Phn`, `district` FROM `ngo` where district='$name'";
