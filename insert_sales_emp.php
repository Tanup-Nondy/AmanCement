    ...
    <section id="services">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp">
          <h3>Data Entry in Sales Employee Database<?php $name=$_SESSION["dis"]; ?> </h3>
		  </center>
        </header>
...
<div class="card mb-3">
	...
	<form method="post" action="insert_sales_emp_action.php">
	  <div class="form-group">
		  <label for="inputPassword4">Name</label>
		  <input type="text" class="form-control" name="name" placeholder="Name of Employee" required>
	  </div>
	  <div class="form-row">	  
	  ...
	  <div class="form-group col-md-3">
		  ...
		  <input type="text" class="form-control" name="exp" placeholder="Working Experience" required>
	  </div>
	  </div>
