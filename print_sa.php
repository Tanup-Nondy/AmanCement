...
<div class="container-fluid" id="div-id-name">
  ...
  <div class="card mb-3">
	<div class="card-header">
	  <i class="fa fa-table"></i> Semi Autonomous of <?php $name=$_SESSION["dis"]; echo $name; ?> District</div>
	<div class="card-body">
...
include ("dbconnect.php");
	...
	$select="SELECT `SI_NO`,`name_of_org`, `name`, `designation`, `contact`, `email`, `office`, `district`, `thana`, `remarks` FROM `sa`where district='$name' AND name_of_org='$cat'";
